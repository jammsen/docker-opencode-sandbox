...
# already use), then point Claude Code at http://127.0.0.1:4001 as described by setup.sh.
set -euo pipefail
...
echo "> starting claude-shim on 127.0.0.1:4001 -> $LITELLM_UPSTREAM (catalog: $MODELS_FILE)"
